...
Insert into Allstar_team_nominees (ssn,player_name,address,birth_date,position,uni_name,team_years,uni_years,times_allstar,Players_ssn,teams_id_no) values (891851561,'Brian Hunt','36673 N 9TH AVE Compton CA 90151','1987-09-18','quarterback','USDSU',4,1,1,891851561,1123);
Insert into Allstar_team_nominees (ssn,player_name,address,birth_date,position,uni_name,team_years,uni_years,times_allstar,Players_ssn,teams_id_no) values (435537974,'Bubba Smith','7733 E 32nd PL St Missouri MS 67891','1992-08-22','center player','MSU',2,1,1,435537974,1125);
Insert into Allstar_team_nominees (ssn,player_name,address,birth_date,position,uni_name,team_years,uni_years,times_allstar,Players_ssn,teams_id_no) values (345621787,'Marcus Williams','3064 Brentwood Drive Austin TX 78758','1989-09-07','tackle','UT',3,2,2,345621787,1126);
Insert into Allstar_team_nominees (ssn,player_name,address,birth_date,position,uni_name,team_years,uni_years,times_allstar,Players_ssn,teams_id_no) values (436376541,'Meyton Panning','571 Poplar Lane Miami FL 33165','1989-05-14','running back','UM',2,1,1,436376541,1127);
Insert into Allstar_team_nominees (ssn,player_name,address,birth_date,position,uni_name,team_years,uni_years,times_allstar,Players_ssn,teams_id_no) values (287728333,'Shawn Hunt','91106 W 22nd PL Seattle WA 98462','1991-09-30','inside receiver','UW',4,4,2,287728333,1124);
Insert into Allstar_team_nominees (ssn,player_name,address,birth_date,position,uni_name,team_years,uni_years,times_allstar,Players_ssn,teams_id_no) values (483214687,'Dennis Lahey','4663 Brentwood Drive Austin TX 78701','1990-05-25','guard','UT',2,2,2,483214687,1126);
Insert into Allstar_team_nominees (ssn,player_name,address,birth_date,position,uni_name,team_years,uni_years,times_allstar,Players_ssn,teams_id_no) values (373554323,'Bruno Hunt','98732 N 16th Blvd Seattle WA 98462','1989-11-29','wide receiver','UW',3,3,2,373554323,1124);
select* from Allstar_team_nominees;

Insert into Allstar_game (game_date,place,winning_team,winning_coach,winning_players,score) values ('2016-06-23','Cowboys Stadium North Texas','UW Team','John Smith','Bruno Hunt, Shawn Hunt',27);
Insert into Allstar_game (game_date,place,winning_team,winning_coach,winning_players,score) values ('2016-07-13','Cowboys Stadium North Texas','UW Team','John Smith','Bruno Hunt, Shawn Hunt',22);
...
Insert into Allstar_game (game_date,place,winning_team,winning_coach,winning_players,score) values ('2017-06-23','Superdome New Orleans Louisiana','UT','Sarah Johnson','Dennis Lahey, Marcus Williams',24);
Insert into Allstar_game (game_date,place,winning_team,winning_coach,winning_players,score) values ('2017-07-14','Superdome New Orleans Louisiana','UT','Sarah Johnson','Dennis Lahey, Marcus Williams',36);
Insert into Allstar_game (game_date,place,winning_team,winning_coach,winning_players,score) values ('2018-06-16','Lucas Oil Stadium Indianapolis Indiana','USDSU','Mike Douglas','Brian Hunt',17);
Insert into Allstar_game (game_date,place,winning_team,winning_coach,winning_players,score) values ('2018-07-07','Lucas Oil Stadium Indianapolis Indiana','MSU','Chris Lange','Bubba Smith',23);
select* from Allstar_game;

Insert into Allstar_game_has_Championship_teams (game_date,id_no) values ('2016-06-23',1124);
Insert into Allstar_game_has_Championship_teams (game_date,id_no) values ('2016-07-13',1124);
...
Insert into Allstar_game_has_Championship_teams (game_date,id_no) values ('2017-07-14',1126);
Insert into Allstar_game_has_Championship_teams (game_date,id_no) values ('2018-06-16',1123);
Insert into Allstar_game_has_Championship_teams (game_date,id_no) values ('2018-07-07',1125);
